...
> ⚠️ 本系統僅提供初步照護需求評估，不取代正式長照評估或醫療診斷。若長者已有急性醫療問題或安全疑慮，請優先聯繫醫療人員或撥打 **1966 長照服務專線**。
...
本專案延伸自中研院「資科漫步」競賽 （題目：**「高齡族群長照使用之時間變化與影響因素分析」**），以 108–112 年銀髮安居模擬資料為基礎，分析年齡、身心障礙程度、家庭型態、低收入身分、住宅條件等因素對長照使用機率的影響。CareGuide 把這些研究發現轉化為可實際操作的網站，讓家屬也能受惠於資料分析的洞見。
